...
export default function Hero() {
    return (
        <div className="relative min-h-[600px]">
            ...
            <div className="absolute right-0 top-1/2 -translate-y-1/2 p-8 bg-transparent text-black max-w-[600px] backdrop-blur-sm md:bg-transparent md:backdrop-blur-0 md:mr-16">
